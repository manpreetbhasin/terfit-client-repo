...
function ClassesBox({ bgImg, title, trainer, date }) {
  return (
    <>
      <div className={`${bgImg} rounded-3xl shadow-2xl flex flex-col h-[460px] relative p-[40px]`}>
        ...
        <div className="flex flex-col align-text-bottom h-full w-full z-[2] justify-end">
          <p className="text-white font-bold text-[27px] mb-3">{title}</p>

          <span className="bg-[#ff0336] w-[50px] h-[4px]"></span>

          <div className="flex gap-6 mb-14 mt-6 text-[#ffffffe1] text-[16px] font-medium">
            <p>
